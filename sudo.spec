...
Source0  : http://www.sudo.ws/dist/sudo-1.8.20p1.tar.gz
Source99 : http://www.sudo.ws/dist/sudo-1.8.20p1.tar.gz.sig
...
export LANG=C
export SOURCE_DATE_EPOCH=1496204385
