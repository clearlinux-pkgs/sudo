...
Source0  : https://www.sudo.ws/dist/sudo-1.9.15p5.tar.gz
Source1  : https://www.sudo.ws/dist/sudo-1.9.15p5.tar.gz.sig
...
%prep
%setup -q -n sudo-1.9.15p5
cd %{_builddir}/sudo-1.9.15p5
%patch -P 1 -p1
%patch -P 2 -p1
%patch -P 3 -p1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1705437894
